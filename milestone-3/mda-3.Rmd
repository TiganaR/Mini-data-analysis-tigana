...
**Research Question**:
Is there a significant difference of flow average among the seasons?
...
<!-------------------------- Start your work below ---------------------------->
```{r}
saveRDS(linear_model, here::here("Output/linear_model.RDS"))
```

```{r}
my_model_rds <- readRDS(here::here("Output/linear_model.RDS"))
my_model_rds
```
